...
api.logInfo("long debug WL logic element2 start2")
...
if (hasFirstLevel) {
    ...
    api.logInfo("long debug WL logic element2 approvers level1", approvers)
...
if (hasFormula || hasSecondLevel) {
    ...
    api.logInfo("long debug WL logic element2 approvers level2", approverReasonMap.keySet())
...
if (hasThirdLevel) {
    ...
    api.logInfo("long debug WL logic element2 approvers level3", approvers)
...
api.logInfo("long debug WL logic element2 start done")
