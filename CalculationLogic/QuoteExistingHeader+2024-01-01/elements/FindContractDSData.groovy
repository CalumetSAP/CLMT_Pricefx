...
def lineRejectedFilter = null
if (lineRejected == "Y") {
    lineRejectedFilter = Filter.equal("RejectionFlag", true)
} else if (lineRejected == "N") {
    lineRejectedFilter = Filter.or(
...
query.identity {
    ...
    if (lineRejectedFilter) where(lineRejectedFilter)
