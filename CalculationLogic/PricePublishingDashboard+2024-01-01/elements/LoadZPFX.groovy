...
//api.global.zpfx = data
//api.global.zpfx20 = data?.groupBy { [it.SalesOrganization, it.ContractNumber, it.SalesDocumentItem, it.Material] }
//api.global.zpfx30 = data?.groupBy { [it.SalesOrganization, it.ContractNumber, it.Material] }
//api.global.zpfxNoShipTo = data?.groupBy { [it.SalesOrganization, it.Division, it.SoldToParty, it.Material] }
