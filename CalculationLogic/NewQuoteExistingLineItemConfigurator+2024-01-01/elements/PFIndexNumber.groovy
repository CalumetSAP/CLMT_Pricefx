...
if (!defaultValue) {
    defaultValue = []
    if (api.local.contractData?.IndexNumberOne) defaultValue.add(api.local.contractData?.IndexNumberOne)
    if (api.local.contractData?.IndexNumberTwo) defaultValue.add(api.local.contractData?.IndexNumberTwo)
    if (api.local.contractData?.IndexNumberThree) defaultValue.add(api.local.contractData?.IndexNumberThree)
}
