...
//
//if (priceType != "1" || !(api.local.indexHasChanged || api.local.priceHasChanged || api.local.adderHasChanged) || !indexValues || lastDaysOfPreviousMonthReferencePeriod != "5") return
//
