...
//
//indexLib.loadReferencePeriodDateFilter(priceType, referencePeriod)



//if (priceType != "1" || !(api.local.indexHasChanged || api.local.priceHasChanged || api.local.adderHasChanged) || !referencePeriod) return
