...
//def basePricing = null
//def basePricingUOM = null
//if (priceType == "2") {
//    def scalesData = calculations.getScalesData(out.FindQuotesDS, out.FindQuoteScales)
//    basePricing = calculations.findBasePricingLineItem(moq, moqUOM, out.FindQuotesDS, scalesData, scalesData?.find()?.ScaleUOM, sku, uomConversionMap, globalUOMConversionMap)
//    basePricingUOM = out.FindQuotesDS?.UOM
//} else if (priceType == "3") {
