if (api.isInputGenerationExecution() || quoteProcessor.isPostPhase() || !out.FindInitZBPL) return

if (!api.local.addedContracts) return

final tablesConstants = libs.QuoteConstantsLibrary.Tables

def condRecNoList = out.FindInitZBPL?.values()?.toList()?.collect { it.ConditionRecordNo } as List
