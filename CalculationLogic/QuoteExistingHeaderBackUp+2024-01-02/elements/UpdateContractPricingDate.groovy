...
trace("Header Configurator Previous Values", null, headerInputConfiguratorValues)
trace("FindContractsForConfigurator Element Lookup", null, contracts)
//api.trace("FindContractsForConfigurator contractsDSData", null, contractsDSData)
...
trace("contractPOMatrixValues", null, contractPOMatrixValues)
trace("contractHiddenInput", null, contractHiddenInput)
//
...
contractHiddenInput?.each { key ->
    ...
    trace("InputContractPO - value", null, value)
    ...
    trace("InputContractPO - prevContractPO", value.SAPContractNumber, prevContractPO)
    trace("InputContractPO - value", null, value)
    trace("InputContractPO - contractsDSData", null, contractsDSData?.collect{it})
    ...
    trace("InputContractPO - prevContractPO.NewContractPricingDate", null, prevContractPO?.NewContractPricingDate)
    trace("InputContractPO - maxLinePricingValidFrom", null, maxLinePricingValidFrom)
    trace("InputContractPO - value.CurrentContractPricingDate", null, value.CurrentContractPricingDate)
    trace("InputContractPO - value.NewContractPricingDate", null, value.PriceValidFrom)
    trace("InputContractPO - lastValidFromNotOnQuote", null, lastValidFromNotOnQuote)
    trace("InputContractPO - prevContractPO?.NewPricingChanged", null, prevContractPO?.NewPricingChanged)
    trace("InputContractPO - maxDate", null, maxDate)
    ...
    trace("InputContractPO - values", null, values)
