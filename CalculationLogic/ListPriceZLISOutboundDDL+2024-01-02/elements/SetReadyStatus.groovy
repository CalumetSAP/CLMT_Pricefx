...
def processingStauts = libs.PricelistLib.Calculations.PROCESSING_STATUS

List<Object> processingPriceLists = calculations.getCPTRowsByStatusAndPlTypes(processingStauts, [pricelistType])

if (!processingPriceLists) return

def processingPLIds = processingPriceLists?.plId
...
final Map dataPayload = ["endRow"        : 1,
                         ...
                         "data"          : ["criteria"    : [["fieldName": "trackerType",
                                                             ...
                                                             ["fieldName": "jobName",
                                                              "operator" : "iContains",
                                                              "value"    : "ListPriceZLISOutboundDDL"]],
                                            "operator"    : "and",
...
completedPricelists.each { pl ->
    calculations.setReadyStatus(pl)
}
