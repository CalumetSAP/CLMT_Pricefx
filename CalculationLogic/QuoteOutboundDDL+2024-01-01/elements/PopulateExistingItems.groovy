...
def row, outputs, lnConfigurator, indexList, indexHasChanged, shipToData, freightTermId, referencePeriodId, contractPOTable, contractEffectiveDate, contractPricingEffectiveDate, contractPO,
