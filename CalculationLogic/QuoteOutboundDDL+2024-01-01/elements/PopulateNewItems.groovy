...
def row, outputs, lnConfigurator, indexList, shipToData, freightTermId, referencePeriodId, contractPOTable, contractEffectiveDate, contractPO,
        contractTableData, division, salesOrg, dsData, freightAmount, deliveredPrice
...
quoteItems?.each { quoteItem ->
    ...
    contractPO = contractTableData?.get("ContractPO")
