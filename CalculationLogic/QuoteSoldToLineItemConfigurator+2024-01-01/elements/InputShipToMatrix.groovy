...
def hiddenColumns = [
        soldToConstants.MATRIX_LINE_ID_HIDDEN_ID,
        soldToConstants.MATRIX_FREIGHT_HAS_CHANGED_ID_HIDDEN_ID,
]
def requiredColumns = [
        soldToConstants.MATRIX_FREIGHT_TERM_ID,
        soldToConstants.MATRIX_INCOTERM_ID,
...
//    input.setConfigParameter("requiredColumns", requiredColumns)
} else {
