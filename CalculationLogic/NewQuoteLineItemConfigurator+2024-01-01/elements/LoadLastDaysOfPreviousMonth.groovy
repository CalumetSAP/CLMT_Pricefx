...
//
//if (priceType != "1" || !(api.local.indexHasChanged || api.local.priceHasChanged || api.local.adderHasChanged || api.local.freightAmountHasChanged) || !indexValues || lastDaysOfPreviousMonthReferencePeriod != "5") return
//
