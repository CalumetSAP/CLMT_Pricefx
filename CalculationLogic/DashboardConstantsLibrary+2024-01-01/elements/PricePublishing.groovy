...
@Field final String ANOTHER_CONTACT_NAME_INPUT_KEY = "AnotherContactName"
@Field final String ANOTHER_CONTACT_NAME_LABEL = "Another Contact Name"
...
@Field final List<String> ENCODED_VARIANT_INPUT_COLUMNS = [
        ...
        SHIP_TO_INPUT_KEY,
        ANOTHER_CONTACT_NAME_INPUT_KEY,
